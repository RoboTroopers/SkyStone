    ...
    public void loop() {
        ...
        */
        ...
        if (gamepad1Advanced.BOnce()) {
            if (robot.pepeSMASH.getState() != Finger.States.UP) {
                robot.pepeSMASH.finger.setPosition(robot.pepeSMASH.FINGER_UP_POS);
            } else {
                robot.pepeSMASH.finger.setPosition(robot.pepeSMASH.FINGER_DOWN_POS);
            }
        }
        ...
        telemetry.addData("finger pos", robot.pepeSMASH.finger.getPosition());
